...
*	Version: 1.0.1
*/
$(document).ready(function(){"use strict";var t,i=".wrapper",e=".side-navigation-wrapper",n="#side-nav-show a",a="#side-nav-hide a",s=".reveal-side-navigation",o=".element-reveal-left",c=".element-reveal-right",r=".element-show-left",l=".element-show-right",d=".content-side-navigation-screen",u=500,v="easeInOutQuint",h={init:function(){$("body").data("aux-nav",!1);var t,f=$(e).hasClass("enter-right")?"right":"left";K?t="left"===f?o:c:(t="left"===f?r:l,$(e).addClass("hide")),t=t.split(".").join(""),$(n).on("click",function(n){if(n.preventDefault(),$(e).hasClass("active"))h.closeNav(t);else{N.state(!0),$("body").data("aux-nav",!0),K?($(s).addClass(t).css({transitionDuration:u+"ms",transitionTimingFunction:Z[v]}),$(e).addClass("active").css({transitionDuration:u+"ms",transitionTimingFunction:Z[v]})):($(i).addClass(t),$(e).removeClass("hide").addClass("active")),O.state(!0),$(e).on(Y,function(t){return t.target!==$(this)[0]?!1:(t.stopPropagation(),void $(this).off(Y))});var a=$('<a href="#" />').addClass(d.split(".").join("")).appendTo($(i));$(a).on("click",function(i){i.preventDefault(),h.closeNav(t)}),$(a).swipeIt({preventTouchOn:e,onSwipeEnd:function(i){"right"===f?"left"===i&&h.closeNav(t):"right"===i&&h.closeNav(t)}})}}),$(a).on("click",function(i){i.preventDefault(),h.closeNav(t)}),$(window).on("resize",function(){O.state($("body").data("aux-nav")?!0:!1)})},closeNav:function(t){K?(N.state(!0),$(s).removeClass(t),$(e).removeClass("active"),$(e).on(Y,function(t){return t.target!==$(this)[0]?!1:(t.stopPropagation(),O.state(!1),void $(this).off(Y))})):($(i).removeClass(t),$(e).addClass("hide").removeClass("active")),$("body").data("aux-nav",!1),$(i).find(d).remove()}},f=".overlay-navigation-wrapper",m=".overlay-navigation-inner",p="#overlay-nav-show a",b="#overlay-nav-hide a",g=500,C="easeInOutQuint",w={init:function(){$(p).on("click",function(t){t.preventDefault(),$("body").data("aux-nav",!0),$(f).addClass("active").css(K?{top:0,transitionDuration:g+"ms",transitionTimingFunction:Z[C]}:{top:0}),$(f).on(Y,function(t){return t.target!==$(this)[0]?!1:(t.stopPropagation(),O.state(!0),void $(this).off(Y))})}),$(m).on("click",function(t){t.target===this&&w.closeNav()}),$(b).on("click",function(t){t.preventDefault(),w.closeNav()}),$(window).on("resize",function(){O.state($("body").data("aux-nav")?!0:!1)})},closeNav:function(){K?($(f).removeClass("active"),$(f).on(Y,function(t){return t.target!==$(this)[0]?!1:(t.stopPropagation(),O.state(!1),$(f).css({top:"-100%"}),void $(this).off(Y))})):$(f).removeClass("active").css({top:"-100%"}),$("body").data("aux-nav",!1)}},y=".side-navigation-wrapper, .overlay-navigation-wrapper",z=".sub-menu",T=".contains-sub-menu",k={init:function(){$(y).find(T).each(function(){$(this).on("click",function(t){t.preventDefault(),N.state(!0);var i=$(this).siblings(z).children(),e=0;i.each(function(){e+=$(this).outerHeight()}),$(this).siblings(z).hasClass("open")?$(this).closest(y).find(z).css({height:0}).removeClass("open"):($(this).closest(y).find(z).css({height:0}).removeClass("open"),$(this).siblings(z).css({height:e+"px"}),$(this).siblings(z).addClass("open"))})})}},O={state:function(t){_?t?$("body").addClass("aux-navigation-active"):$("body").removeClass("aux-navigation-active"):t?$("body").addClass("aux-navigation-active"):$("body").data("aux-nav")||$("body").removeClass("aux-navigation-active")}},I=".header *, .reveal-side-navigation, .side-navigation-wrapper",N={init:function(){_||$(window).on("scroll",function(){N.state(!0)}),$(window).on("resize",function(){N.state(!1)})},state:function(t){t?$(I).removeClass("no-transition"):$(I).addClass("no-transition")}},x=300,E=".scroll-to-top",D=600,Q={init:function(){$(window).on("scroll",function(){return $(E).is("[data-no-hide]")?!1:void($(this).scrollTop()>x?$(E).fadeIn(D):$(E).fadeOut(D))}),$(E).on("click",function(t){t.preventDefault(),Q.scrollUp()})},scrollUp:function(){$("html, body").animate({scrollTop:0},D)}},B=".tabs",P=".accordion",A="icon-plus",F="icon-minus",S=".box.dismissable",M=300,W="swing",L=".dropdown",j=".thumbnail",H=".overlay-info",R=400,U="swing",q={init:function(){q.tabs(),q.accordions(),q.dismissable(),q.dropdown(),q.rollovers(),q.thumbnailRatio()},tabs:function(){$(B).each(function(){var t=$(this).find("li a");t.each(function(){$(this).on("click",function(){var t=$(this).attr("href"),i=$(this).closest(".tabs").find(t);return $(this).closest(".tab-nav").find(".active").removeClass("active"),$(this).parent().addClass("active"),$(this).closest(".tabs").find(".content.active").removeClass("active"),i.addClass("active"),!1}),$(this).parent().hasClass("active")&&$(this).closest(".tabs").find($(this).attr("href")).addClass("active")})})},accordions:function(){$(P).each(function(){var t=$(this).find("li a");t.each(function(){$(this).closest(P).is("[data-toggle-icon]")&&($(this).find("span").length||$(this).parent().hasClass("active")?!$(this).find("span").length&&$(this).parent().hasClass("active")&&$(this).prepend('<span class="'+F+'" />'):$(this).prepend('<span class="'+A+'" />')),$(this).on("click",function(){var t=$(this).attr("href"),i=$(this).closest(P).find(t);return $(this).closest(P).is("[data-toggle-multiple]")||($(this).closest(P).find("li.active").not($(this).parent()).removeClass("active"),$(this).closest(P).find(".content.active").not(i).removeClass("active")),$(this).parent().toggleClass("active"),i.toggleClass("active"),$(this).find("."+F).length?$(this).find("."+F).removeClass(F).addClass(A):$(this).find("."+A).length&&($(this).closest(P).is("[data-toggle-multiple]")||$(this).closest("ul").find("."+F).removeClass(F).addClass(A),$(this).find("."+A).removeClass(A).addClass(F)),!1}),$(this).parent().hasClass("active")&&$(this).parent().find(".content").addClass("active")})})},dismissable:function(){$(S).each(function(){$(this).find(".close").length||$(this).prepend('<a href="" class="close icon-cancel" />'),$(this).find(".close").on("click",function(t){t.preventDefault(),K?$(this).parent().css({transitionProperty:"opacity",opacity:0,transitionDuration:M+"ms",transitionTimingFunction:Z[W]}).on(Y,function(t){return t.stopPropagation(),t.target!==$(this)[0]?!1:void $(this).remove()}):$(this).parent().animate({opacity:0},R,W,function(){$(this).remove()})})})},dropdown:function(){$(L).each(function(){$(this).find(".button, button").each(function(){$(this).on("click",function(t){t.preventDefault();var i=$(this).parent().children(".dropdown-list");return $(this).parent().hasClass("disabled")?!1:($(".dropdown-list").not($(i)).removeClass("active"),void($(i).hasClass("active")?$(i).removeClass("active"):$(i).addClass("active")))}),$(this).parent().children(".dropdown-list").find("li a").on("click",function(t){t.preventDefault(),$(".dropdown-list").removeClass("active")})})})},rollovers:function(){K?$(H).css({transitionDuration:R+"ms",transitionTimingFunction:Z[U]}):$(j).find(".overlay-link").mouseenter(function(){$(this).find(H).css({opacity:0}).stop().animate({opacity:1},R,U)}).mouseleave(function(){$(this).find(H).stop().animate({opacity:0},R,U)})},thumbnailRatio:function(){$(window).on("resize",function(){$(j).each(function(){if($(this).find(".caption-over-outer").length){var t=$(this).find("img"),i=t.attr("width"),e=t.attr("height"),n=$(this).find("img").width(),a=e>i?e/i:i/e,s=e>i?n*a:n/a;$(this).find(".caption-over-outer").css({opacity:1}),$(this).css({height:s+"px"})}})}).resize()}},G=document.body||document.documentElement,J=G.style,K=void 0!==J.transition||void 0!==J.WebkitTransition||void 0!==J.MozTransition||void 0!==J.MsTransition||void 0!==J.OTransition,V=["WebkitTransform","MozTransform","OTransform","msTransform"];for(var X in V)void 0!==J[V[X]]&&(t="-"+V[X].replace("Transform","").toLowerCase());var Y="webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend";K&&(document.getElementsByTagName("body")[0].className+=" transition-support");var Z={linear:"cubic-bezier(0, 0, 1, 1)",swing:"cubic-bezier(0.42, 0, 0.58, 1)",easeOutCubic:"cubic-bezier(.215,.61,.355,1)",easeInOutCubic:"cubic-bezier(.645,.045,.355,1)",easeInCirc:"cubic-bezier(.6,.04,.98,.335)",easeOutCirc:"cubic-bezier(.075,.82,.165,1)",easeInOutCirc:"cubic-bezier(.785,.135,.15,.86)",easeInExpo:"cubic-bezier(.95,.05,.795,.035)",easeOutExpo:"cubic-bezier(.19,1,.22,1)",easeInOutExpo:"cubic-bezier(1,0,0,1)",easeInQuad:"cubic-bezier(.55,.085,.68,.53)",easeOutQuad:"cubic-bezier(.25,.46,.45,.94)",easeInOutQuad:"cubic-bezier(.455,.03,.515,.955)",easeInQuart:"cubic-bezier(.895,.03,.685,.22)",easeOutQuart:"cubic-bezier(.165,.84,.44,1)",easeInOutQuart:"cubic-bezier(.77,0,.175,1)",easeInQuint:"cubic-bezier(.755,.05,.855,.06)",easeOutQuint:"cubic-bezier(.23,1,.32,1)",easeInOutQuint:"cubic-bezier(.86,0,.07,1)",easeInSine:"cubic-bezier(.47,0,.745,.715)",easeOutSine:"cubic-bezier(.39,.575,.565,1)",easeInOutSine:"cubic-bezier(.445,.05,.55,.95)",easeInBack:"cubic-bezier(.6,-.28,.735,.045)",easeOutBack:"cubic-bezier(.175, .885,.32,1.275)",easeInOutBack:"cubic-bezier(.68,-.55,.265,1.55)"};window.onpageshow=function(t){t.persisted&&$("body").addClass("page-fade-reset").removeClass("page-fade-out")};var _=!1;(navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/webOS/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPad/i)||navigator.userAgent.match(/iPod/i)||navigator.userAgent.match(/BlackBerry/i)||navigator.userAgent.match(/Windows Phone/i))&&(_=!0,document.getElementsByTagName("body")[0].className+=" mobile");var ti="WebkitAppearance"in document.documentElement.style;ti&&(document.getElementsByTagName("body")[0].className+=" webkit");var ii=/constructor/i.test(window.HTMLElement);ii&&(document.getElementsByTagName("body")[0].className+=" safari-browser");var ei=document.all&&document.addEventListener||"-ms-scroll-limit"in document.documentElement.style&&"-ms-ime-align"in document.documentElement.style;ei&&(document.getElementsByTagName("body")[0].className+=" ie-browser"),h.init(),w.init(),k.init(),N.init(),Q.init(),q.init()});
/**
*	Avalanche Slider
*	Version: 1.0.1
*/
...
/**
*	Summit Lightbox
*	Version: 1.0 Beta - Matteo
*/
!function(t,i,e,n){"use strict";var a=function(i,n){var a=t.extend({},t.fn.summitLightbox.tmlOpts,n),l=t(i),d=this,h=[];l.on("click",function(i){i.preventDefault(),t(l).data("group")&&(h=o(l)),t(this).addClass("tml-active"),s(h,a,d)}),t(e).on("resize",function(){u(a)}),d.nextContent=function(){var i=t("#tml-content");if(i.data("loading"))return!1;f(0,a);var e=t(".tml-active"),n=o(e),r=n[t.inArray(e.attr("id"),n)+1];r=t.inArray(r,n)+1===0?n[0]:r,e.removeClass("tml-active"),r=t("#"+r).addClass("tml-active"),c(r,"next",a),n.length=0},d.prevContent=function(){var i=t("#tml-content");if(i.data("loading"))return!1;f(0,a);var e=t(".tml-active"),n=o(e),r=n[t.inArray(e.attr("id"),n)-1];r=t.inArray(r,n)+1===0?n[n.length-1]:r,e.removeClass("tml-active"),r=t("#"+r).addClass("tml-active"),c(r,"prev",a),n.length=0},d.destroyLightbox=function(){var i=t("#tm-lightbox"),e=t("#tml-content"),n=null,o=r(i,a);if(b){if(i.data("transitioning"))return!1;i.children().css({transition:"none"}),e.css({transition:"none"}),i.one(C,function(){clearTimeout(n),n=setTimeout(function(){i.find("iframe").attr("src",""),i.remove(),i=null},50)}),m(i,0,o.x,o.y,a)}else{if(i.is(":animated"))return!1;e.remove(),i.animate({opacity:0,left:o.x+"px",top:o.y+"px"},a.speed,a.easing,function(){i.find("iframe").attr("src",""),i.remove(),i=null})}h.length=0,t(".tml-active").removeClass("tml-active"),a.onExit&&a.onExit()}},o=function(i){if(t(i).is("[data-group]")){var e=t(i).data("group"),n=[];return t('[data-group="'+e+'"]').each(function(i){i++,t(this).attr("id")?n.push(t(this).attr("id")):(t(this).attr("id",e+"-tml-thumb-"+i),n.push(t(this).attr("id")))}),n}},r=function(i,n){var a=n.lightboxAnimation,o="slideInLeft"===a||"slideInTop"===a?-1:"slideInRight"===a||"slideInBottom"===a?1:0,r="slideInLeft"===a||"slideInRight"===a?t(e).width()*o:0,s="slideInTop"===a||"slideInBottom"===a?t(e).height()*o:0;return{x:r,y:s}},s=function(e,n,a){if(t("#tm-lightbox").length)return!1;t("body").append('<div id="tm-lightbox" class="tm-lightbox"><div id="tml-content-wrapper" ><div id="tml-content" /></div><div id="tml-caption" /></div>');var o=t("#tm-lightbox"),s=t("#tml-content-wrapper"),c=t("#tml-content"),d=null;o.data("initLoad",!0);var u=n.contentMargin;if(s.css({top:u+"%",right:u+"%",bottom:u+"%",left:u+"%"}),e.length<2||c.swipeIt({preventTouchOn:".scrollable-content",onSwipeMove:function(t){c.css({left:t+"px"})},onSwipeEnd:function(t){"left"===t?a.prevContent():a.nextContent()}}),n.overlay||o.css({background:"none"}),n.navArrows&&e.length>=2){var f=t('<a href="#" />').attr("id","tml-prev").addClass("tml-nav").appendTo(o),h=t('<a href="#" />').attr("id","tml-next").addClass("tml-nav").appendTo(o);f.on("click",function(t){t.preventDefault(),a.prevContent()}),h.on("click",function(t){t.preventDefault(),a.nextContent()})}if(n.navExit){var p=t('<a href="" id="tml-exit" class="tml-nav" />').appendTo(o);p.on("click",function(t){t.preventDefault(),a.destroyLightbox()})}n.navKeyboard&&t(i).on("keyup",function(t){37!=t.keyCode||e.length<2?39!=t.keyCode||e.length<2?27==t.keyCode&&a.destroyLightbox():a.nextContent():a.prevContent()}),n.overlayClickClose&&o.on("click",function(t){(t.target===this||"tml-content-wrapper"===t.target.id)&&a.destroyLightbox()});var v=r(o,n);if(b){if(o.css({transition:"none",transform:"translate3d("+v.x+"px, "+v.y+"px, 0px)"}),o.data("transitioning"))return!1;clearTimeout(d),d=setTimeout(function(){o.one(C,function(){l(t(".tml-active"),"next",n)}),m(o,1,0,0,n)},50)}else o.css({left:v.x+"px",top:v.y+"px"}),o.animate({opacity:1,left:0,top:0},n.speed,n.easing,function(){l(t(".tml-active"),"next",n)})},c=function(i,e,n){var a=(t("#tm-lightbox"),t("#tml-content"));a.data("loading",!0);var o="fade"===n.contentAnimation?0:n.slideAmount;if(e="next"===e?1:-1,b)a.one(C,function(){t(this).css({visibility:"hidden"}),l(i,e,n)}),m(a,0,-o*e,0,n);else{var r=a.position().left;a.animate({opacity:0,left:r-o*e+"px"},n.speed,n.easing,function(){t(this).css({visibility:"hidden"}),l(i,e,n)})}},l=function(i,n,a){var o=t("#tm-lightbox"),r=t("#tml-content");o.addClass("loading"),r.find("iframe").attr("src",""),r.removeClass("tml-error scrollable-content").data("type","").html("");var s=i.attr("href"),c=s.match(/\.(jpeg|jpg|png|gif)/i),l=s.match(/(vimeo\.com|youtu(be\.com|\.be))\/(watch\?v=)?([A-Za-z0-9._%-]*)(\&\S+)?/),u=i.is('[data-content="inline"]'),m=i.is('[data-content="iframe"]'),f=i.is('[data-content="ajax"]');if(t("#tml-loader").length&&t("#tml-loader").remove(),o.append('<div id="tml-loader" class="tm-loader"><div id="circle" /></div>'),c){var h=s.substr(s.lastIndexOf("."));(e.isRetinaDevice()&&a.retinaSupport||e.isRetinaDevice()&&i.is("[data-retina]"))&&(!z&&!a.retinaSupportMobile||z&&a.retinaSupportMobile)&&(s=s.replace(h,a.retinaSuffix+h)),r.data("type","img"),t("<img />").addClass("tml-image").attr("src",s).one("load",function(){r.html(t(this)),d(!0,n,a)}).each(function(){this.complete&&t(this).trigger("load")}).on("error",function(){d(!1,n,a)})}if(l){r.data("type","video");var p=t('<iframe src="'+s+'" wmode="opaque" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen />');r.html(p),p.one("load",function(){d(!0,n,a)})}if(u)if(r.addClass("scrollable-content").data("type","inline"),t(s).length){var v=t(s).clone().css({display:"block",visibility:"visible",opacity:1});r.html(v),d(!0,n,a)}else d(!1,n,a);if(m){r.addClass("scrollable-content").data("type","iframe");var b=t('<iframe src="'+s+'" frameborder="0" scrolling="auto" />');r.html(b),b.one("load",function(){d(!0,n,a)})}if(f){r.addClass("scrollable-content").data("type","ajax");var g=i.data("target-container");t.ajax({url:s,cache:!1,success:function(i){r.html(t(i).find(g).length?t(i).find(g):i),d(!0,n,a)},error:function(){d(!1,n,a)}})}},d=function(i,e,n){var a=t("#tm-lightbox"),o=t("#tml-content");a.removeClass("loading");var r=null;if(u(n),a.find("#tml-loader").remove(),i){var s="fade"===n.contentAnimation?0:n.slideAmount;if(b)o.css({transition:"none",opacity:0,transform:"translate3d("+s*e+"px, 0, 0)"}),clearTimeout(r),r=setTimeout(function(){o.one(C,function(){o.data("loading",!1)}),m(o,1,0,0,n)},50);else{var c=o.position().left,l=a.data("initLoad")?c:1===e?c+2*s:c-2*s;o.css({visibility:"visible",left:l+"px"}).animate({opacity:1,left:c+"px"},n.speed,n.easing,function(){o.data("loading",!1)})}f(1,n),n.onLoaded&&n.onLoaded()}else{var d="";n.showErrorSrc&&(d=": "+t(".tml-active").attr("href")),o.css({width:"100%",height:"auto",top:"50%",left:0,transition:"none",transform:"translate3d( 0, 0, 0)"}).addClass("tml-error").html(n.errorMessage+d),b?(clearTimeout(r),r=setTimeout(function(){o.one(C,function(){o.data("loading",!1)}),m(o,1,0,0,n)},50)):o.css({visibility:"visible"}).animate({opacity:1},function(){o.data("loading",!1)})}a.data("initLoad",!1)},u=function(i){var e=t("#tml-content-wrapper").width(),n=t("#tml-content-wrapper").height(),a=t("#tml-content"),o=a.data("type"),r=0,s=0,c=0,l=0,d=0;if(a.not(".tml-error").css({height:"auto",width:"auto",top:"",left:""}),"img"===o)s=a.find("img").width(),c=a.find("img").height();else if("video"===o)s=i.maxWidth,c=s/1.778;else if("iframe"===o)s=e<i.maxWidth?e:i.maxWidth,c=n;else{var u=a.children().outerWidth(),m=a.children().outerHeight();s=e>u&&u<=i.maxWidth?u:u>i.maxWidth?i.maxWidth:e,c=n>m?m:n}("img"===o||"video"===o)&&(r=s/c>e/n?s/e:c/n,s=s/r>s?s:s/r,c=c/r>c?c:c/r),d=(e-s)/2,l=(n-c)/2,a.css({width:Math.round(s)+"px",height:Math.round(c)+"px",top:Math.round(l)+"px",left:Math.round(d)+"px"})},m=function(i,e,n,a,o){{var r=t("#tm-lightbox");t("#tml-content")}"tm-lightbox"===i.attr("id")&&r.data("transitioning",!0);var s={};s.transform="translate3d("+n+"px, "+a+"px, 0px)",s.transitionProperty=y+", opacity",s.transitionDuration=o.speed+"ms",s.transitionTimingFunction=w[o.easing],s.visibility="visible",s.opacity=e,i.css(s).one(C,function(e){e.stopPropagation(),t(this).off(C),"tm-lightbox"===i.attr("id")&&r.data("transitioning",!1)})},f=function(i,e){var n=t("#tml-caption"),a=t(".tml-active").data("caption");a?(n.html(t("<span />").text(a)),b?m(t("#tml-caption"),i,0,0,e):t("#tml-caption").animate({opacity:i})):n.html("")};e.isRetinaDevice=function(){var t="(-webkit-min-device-pixel-ratio: 1.5), (min--moz-device-pixel-ratio: 1.5), (-o-min-device-pixel-ratio: 3/2), (min-resolution: 1.5dppx)";return this.devicePixelRatio>1||this.matchMedia&&this.matchMedia(t).matches?!0:!1};var h,p=i.body||i.documentElement,v=p.style,b=v.transition!==n||v.WebkitTransition!==n||v.MozTransition!==n||v.MsTransition!==n||v.OTransition!==n,g=["WebkitTransform","MozTransform","OTransform","msTransform"];for(var x in g)v[g[x]]!==n&&(h="-"+g[x].replace("Transform","").toLowerCase());var y=h+"-transform",C="webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",w={linear:"cubic-bezier(0, 0, 1, 1)",swing:"cubic-bezier(0.42, 0, 0.58, 1)",easeOutCubic:"cubic-bezier(.215,.61,.355,1)",easeInOutCubic:"cubic-bezier(.645,.045,.355,1)",easeInCirc:"cubic-bezier(.6,.04,.98,.335)",easeOutCirc:"cubic-bezier(.075,.82,.165,1)",easeInOutCirc:"cubic-bezier(.785,.135,.15,.86)",easeInExpo:"cubic-bezier(.95,.05,.795,.035)",easeOutExpo:"cubic-bezier(.19,1,.22,1)",easeInOutExpo:"cubic-bezier(1,0,0,1)",easeInQuad:"cubic-bezier(.55,.085,.68,.53)",easeOutQuad:"cubic-bezier(.25,.46,.45,.94)",easeInOutQuad:"cubic-bezier(.455,.03,.515,.955)",easeInQuart:"cubic-bezier(.895,.03,.685,.22)",easeOutQuart:"cubic-bezier(.165,.84,.44,1)",easeInOutQuart:"cubic-bezier(.77,0,.175,1)",easeInQuint:"cubic-bezier(.755,.05,.855,.06)",easeOutQuint:"cubic-bezier(.23,1,.32,1)",easeInOutQuint:"cubic-bezier(.86,0,.07,1)",easeInSine:"cubic-bezier(.47,0,.745,.715)",easeOutSine:"cubic-bezier(.39,.575,.565,1)",easeInOutSine:"cubic-bezier(.445,.05,.55,.95)",easeInBack:"cubic-bezier(.6,-.28,.735,.045)",easeOutBack:"cubic-bezier(.175, .885,.32,1.275)",easeInOutBack:"cubic-bezier(.68,-.55,.265,1.55)"},z=!1;(navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/webOS/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPad/i)||navigator.userAgent.match(/iPod/i)||navigator.userAgent.match(/BlackBerry/i)||navigator.userAgent.match(/Windows Phone/i))&&(z=!0),t.fn.summitLightbox=function(i){return this.each(function(){var e=t(this);if(!e.data("summitLightbox")){var n=new a(this,i);e.data("summitLightbox",n)}})},t.fn.summitLightbox.tmlOpts={lightboxAnimation:"fade",contentAnimation:"slide",slideAmount:100,easing:"swing",speed:350,overlay:!0,maxWidth:1140,contentMargin:15,navArrows:!0,navKeyboard:!0,navExit:!0,overlayClickClose:!0,retinaSupport:!0,retinaSupportMobile:!1,retinaSuffix:"@2x",errorMessage:"Please Check",showErrorSrc:!0,onSetup:null,onLoaded:null,onDestroy:null}}(jQuery,document,window);
/**
*	Snowbridge Parallax
*	Version: 1.0
*/
